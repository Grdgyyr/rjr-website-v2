  ...
  return (
    <Section id="footer" crosses className="!px-0 !py-10">
      <div className="container flex justify-between items-center w-full max-sm:flex-col max-sm:gap-10">
        <div className="flex justify-start w-full max-sm:justify-center">
            ...
            {socials.map((item) => {
              ...
              return (
                <li key={item.id} className="flex items-center gap-3">
                  <a href={href} target={targetAttr} rel="noopener noreferrer" className="flex items-center text-white text-sm">
                    <span className="flex items-center justify-center w-10 h-10 bg-n-7 rounded-full transition-colors hover:bg-n-6">
